...
A data frame is a tabular object made of equal length vectors. 
...
```{r}
df1 <- tibble(x = 1:3)
df2 <- tibble(x = c(1, 5), y = c("first", "fifth"))
df1 %>% inner_join(df2, by = join_by(x))
```
...
airports <- read_rds("data/planes.rds")
...
write_csv(adelie_males_on_torgersen_in_2007, "adelie_males_on_torgersen_in_2007.csv")
write_rds(adelie_males_on_torgersen_in_2007, "adelie_males_on_torgersen_in_2007.rds")

library(writexl)
write_xlsx(adelie_males_on_torgersen_in_2007, "adelie_males_on_torgersen_in_2007.xlsx")
